...
# -*- coding: utf-8 -*-
"""
Created on Fri Feb  8 09:50:46 2019
...
#image = mpimg.imread('images/solidYellowLeft.jpg')
...
def pipeline(image):
    ...
    #coefficent multiplied should be changed depends on how far we go into the image
...
clip1 = VideoFileClip("images/solidYellowLeft.mp4")
